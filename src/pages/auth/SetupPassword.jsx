...
const SetupPassword = () => {
  ...
  // Kunin ang token at email mula sa URL (e.g., ?token=123&email=abc@gmail.com)
  ...
  // Kung walang token o email sa URL, error agad
  if (!token || !email) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans">
        <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center border border-red-100">
          ...
          <p className="text-slate-500 text-sm mb-6">Ang setup link na ito ay sira o hindi kumpleto. Mangyaring i-check ang email na ipinadala sa iyo.</p>
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans">
        <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl max-w-md w-full text-center border border-slate-100 animate-in zoom-in duration-500">
          ...
          <p className="text-slate-500 text-sm mb-8 leading-relaxed">
            Ang iyong password ay matagumpay na nai-save at ang iyong account ay <b>Verified</b> na. Maaari ka nang mag-login.
          </p>
          <button 
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 p-8">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button 
              ...
              style={{ backgroundColor: branding.theme_color || '#2563eb' }}
            >
              {loading ? <><Loader2 size={18} className="animate-spin" /><span>Saving...</span></> : <span>Secure My Account</span>}
            </button>
          </form>
        </div>
      </div>
